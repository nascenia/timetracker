...
ActiveRecord::Schema.define(version: 20171123053738) do
  ...
  add_index 'comments',
            ['leave_id'],
            name: 'index_comments_on_leave_id',
            using: :btree
  add_index 'comments',
            ['user_id'],
  ...
  add_index 'exclusion_dates',
            ['excluded_id', 'excluded_type'],
            name: 'index_exclusion_dates_on_excluded_id_and_excluded_type',
            using: :btree
  ...
  add_index 'holiday_schemes',
            ['leave_year_id'],
            name: 'index_holiday_schemes_on_leave_year_id',
            using: :btree
  ...
  add_index 'holidays',
            ['holiday_scheme_id'],
            name: 'index_holidays_on_holiday_scheme_id',
            using: :btree
  ...
  add_index 'leave_trackers', ['user_id'],
            name: 'index_leave_trackers_on_user_id', using: :btree
  ...
  add_index 'leaves',
            ['approval_path_id'],
            name: 'index_leaves_on_approval_path_id',
            using: :btree
  add_index 'leaves',
            ['user_id'],
            name: 'index_leaves_on_user_id',
            using: :btree
  ...
  add_index 'path_chains',
            ['approval_path_id'],
            name: 'index_path_chains_on_approval_path_id',
            using: :btree
  ...
  add_index 'users',
            ['holiday_scheme_id'],
            name: 'index_users_on_holiday_scheme_id',
            using: :btree
  add_index 'users',
  ...
  add_index 'users',
            ['weekend_id'],
            name: 'index_users_on_weekend_id',
            using: :btree
