ActiveAdmin.register Kpi do
  ...
  #
  permit_params :start_date, :end_date, :ttf_comment, :team_member_comment, :data, :status, :user_id
  #
  # or
  #
  # permit_params do
  #   permitted = [:start_date, :end_date, :ttf_comment, :team_member_comment, :data, :status, :user_id]
